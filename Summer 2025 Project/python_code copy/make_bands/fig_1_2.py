...
def compute_bands(ref_year, ref_month, ref_day, flag_save, T, K, N0, level_rate, pay_yy):
    ...
    plt.title('Notional mortgage profile, rate =%.4f, Date=%s'%(np.round(K,6), date_str_to_plot))
...
if __name__ == '__main__':
    ...
    ptf_to_process = pd.read_excel(open('/Users/bilal/Desktop/Summer 2025 Project/python_code copy/make_bands/input/ptf_to_process_for_bands_fig_v0.xlsx', 'rb'), sheet_name='PTF_TO_PROCESS')
