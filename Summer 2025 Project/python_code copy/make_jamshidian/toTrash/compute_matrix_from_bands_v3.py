...
if __name__ == "__main__":
	...
	#file_bande_v0 = 'input/focus_mkt_dates_v0/30YL20131231_pp0.01_0.1.xlsx'
	file_bande_v0 = 'input/focus_mkt_dates_v0/30YL20131231_pp0.01_0.05.xlsx'
	strikeIn = 0.0358




	#file_bande_v0 = 'input/bande/30YL20200731_pp0.01_0.02.xlsx'
	#file_bande_v0 = 'input/bande/30YL20200731_pp0.01_0.03.xlsx'
	#file_bande_v0 = 'input/bande/30YL20200731_pp0.01_0.05.xlsx'
	#file_bande_v0 = 'input/bande/30YL20200731_pp0.01_0.07.xlsx'
	#file_bande_v0 = 'input/bande/30YL20200731_pp0.01_0.1.xlsx'
	#strikeIn = 0.0094

	#file_bande_v0 = 'input/bande/30YL20220331_pp0.01_0.02.xlsx'
	#file_bande_v0 = 'input/bande/30YL20220331_pp0.01_0.03.xlsx'
	#file_bande_v0 = 'input/bande/30YL20220331_pp0.01_0.05.xlsx'
	#file_bande_v0 = 'input/bande/30YL20220331_pp0.01_0.07.xlsx'
	#file_bande_v0 = 'input/bande/30YL20220331_pp0.01_0.1.xlsx'
	#strikeIn = 0.0231
	...
	print('Start elab')
	# funzione che stampa il risultato dell'operazioni di replica del portafoglio all'interno di anag_ptf_swp
	...
	# cmputeMatrixToCalib(anag_ptf_swpt, ptf_swpt_calib_csv, 'csv')
	print('End elab!!')
