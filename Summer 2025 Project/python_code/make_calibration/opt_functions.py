...
import funzioni_g2pp as g2pp_f

from utils_g2pp_newton import price_swaption
...
def compute_swaptions_price_test(prm_g2pp, strike_tmp, t_exp, t_mat, rf_curve_dict):
...
def loss_calib_model(list_model_params, mkt_prices_dict, rf_curve_dict, mdl_flag, shift_ref):
    ...
    for exp_tmp in exp_mkt_list:
        ...
        for mat_tmp in mkt_prices_dict[exp_tmp].keys():
            ...
            #print('list_model_params: ', list_model_params)
            ...
            diff = diff*diff
            diff_sum = diff_sum + diff
            #print('mkt_price_tmp: ', mkt_price_tmp)
